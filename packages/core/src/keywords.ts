...
export const dateMethods = new Map([
  ...
  ['obtenerAñoCompleto', 'getFullYear'],
  ...
  ['obtenerAñoCompletoUTC', 'getUTCFullYear'],
  ...
  ['establecerAnioCompleto', 'setFullYear'],
  ['establecerAñoCompleto', 'setFullYear'],
  ...
  ['establecerAñoCompletoUTC', 'setUTCFullYear'],
