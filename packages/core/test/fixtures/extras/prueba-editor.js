...
async function principal() {
    ...
    Terminal.escribir('¡Hola mundo desde ' + tiza.indigo800.fondoIndigo50(' EsJS ') + '!');
    
    Terminal.escribir('Aprende más sobre EsJS en ' + Terminal.enlace('https://es.js.org', tiza.indigo800.fondoIndigo50(' https://es.js.org ')));
    
    Terminal.escribir('*'.repeat(50));
    // Separador
    Terminal.escribir('Este es un ejemplo de como usar la Terminal. Selecciona una opcion:');
