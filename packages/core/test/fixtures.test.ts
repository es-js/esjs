...
const plugins = [
  ...
  'parametroaudio',
  'mapaparametroaudio',
  'nodofuentedeaudioprogramable',
  'nodooscilador',
  'bufferaudio',
  'nodofuentedebufferaudio',
  'nodofuentedeaudioelementodemedios',
  'nodofuentedeaudioflujodemedio',
  'nodofuentedeaudiopistaflujodemedios',
  'nodofiltrobiquad',
  'nodoconvolucionador',
  'nodoretraso',
  'nodocompresordinamico',
  'nodoganancia',
  'nodomoldeadordeonda',
  'ondaperiodica',
  'nododestinodeaudio',
  'nododestinodeaudioflujodemedios',
  'nodoanalizador',
  'nododivisordecanales',
  'nodofusionadordecanales',
  'oyenteaudio',
  'nodopanoramico',
  'nodopanoramicoestereo',
  'nodoprocesadordeaudio',
  'ambitoglobaldeprocesadordeaudio',
  'contextoaudiosinconexion',
  'eventodefinalizaciondeaudiosinconexion',
  'elementohtmldemedios',
  'eventodemedioscifrados',
  'listadepistasdeaudio',
  'eventodepista',
  'pistadeaudio',
  'fuentedemedios',
  'clavesmultimedia',
  'listadepistasdetexto',
  'listadepistasdevideo',
  'pistadetexto',
  'pistadevideo',
  'listademarcadoresdepistadetexto',
  'procesadordeaudio',
  'procesadortrabajodeaudio',
  'reproduccionremota',
  'nodofiltroiir',
]
