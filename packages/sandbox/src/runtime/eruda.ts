...
export function openEruda() {
	...
	const lunaTabSliderElement: HTMLElement | null =
		document.querySelector('.luna-tab-slider')
...
function setupErudaConsoleClickHandler() {
	const erudaConsoleTab = document.querySelector(
		'.luna-tab-item[data-id="console"]',
	)
...
function setupErudaFlowchartClickHandler() {
	const erudaFlowchartTab = document.querySelector(
		'.luna-tab-item[data-id="flowchart"]',
	)
...
function fixDevToolsPadding() {
	const erudaDevToolsElements =
		document.getElementsByClassName('eruda-dev-tools')
	const erudaDevToolsElement: HTMLElement | null = erudaDevToolsElements.length
		? (erudaDevToolsElements[0] as HTMLElement)
		: null
