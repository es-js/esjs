        ...
        >
          ...
          >
            <button id="refresh-button"
                    class="h-full flex flex-row items-center px-2 py-1 space-x-1 text-sm bg-gray-100 hover:bg-gray-200 text-gray-900 dark:bg-gray-800 dark:hover:bg-gray-600 dark:text-white rounded-tl cursor-pointer"
                    title="Refrescar"
            ...
            <div
              class="h-full flex flex-row items-center px-2 py-1 space-x-1 text-sm bg-gray-100 hover:bg-gray-200 text-gray-900 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-white cursor-pointer"
            >
