        ...
        'esjs': {
          patterns: [
            ...
            },
            {
              ...
              match: '\\b(consola|depurador|establecerTemporizador|establecerIntervalo|Fecha|Numero|Mate|Matriz|Arreglo|Booleano|Cadena|Funcion|Promesa)\\b',
            },
            {
              name: 'storage.type.esjs',
              match: '\\b(asincrono|clase|const|global|var|porDefecto|obtener|establecer|funcion)\\b',
            },
            {
